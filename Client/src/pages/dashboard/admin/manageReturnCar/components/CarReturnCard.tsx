...
const CarReturnCard = ({ booking }: TCarReturnCard) => {
  const car = booking.car;
  const totalTime =
    (new Date().valueOf() - new Date(booking.startTime).valueOf()) /
    1000 /
    60 /
    60;
  const totalCost = (totalTime * booking.pricePerHour).toFixed(2);
