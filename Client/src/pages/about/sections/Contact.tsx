const Contact = () => {
  return (
    <section className=" py-10 bg-primary-color rounded-lg">
      <div className=" space-y-2 ">
        <h1 className=" text-3xl font-bold text-white text-center pb-10">
          Contact Us
        </h1>
        <div className=" py-5 grid grid-cols-1 md:grid-cols-3 gap-5">
          <div className="  text-white flex flex-col justify-center items-center gap-3">
            ...
            <h1 className="text-white font-semibold text-xl">Address</h1>
            <div className="space-y-1 text-center">
              <h1 className="  font-bold">
                738 New Green Street, <br /> Newyork City United Kingdom
              </h1>
            </div>
          </div>
          <div className="  text-white flex flex-col justify-center items-center gap-3">
          ...
          <div className="  text-white flex flex-col justify-center items-center gap-3">
            ...
            <div className="space-y-1 text-center">
              <h1 className="  font-bold">xyz@gmail.com</h1>
            </div>
          </div>
        </div>
      </div>
