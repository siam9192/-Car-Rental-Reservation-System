          ...
          return (
            <div className="space-y-2" key={index}>
              ...
              <div className=" space-y-1 text-center">
                <h1 className=" text-xl md:text-2xl text-black dark:text-slate-100 font-jakarta font-extrabold">
                  {member.name}
                </h1>
                <h2 className=" text-xs text-black  dark:text-slate-100  font-jakarta font-extrabold">
                  {member.position}
                </h2>
              </div>
            </div>
