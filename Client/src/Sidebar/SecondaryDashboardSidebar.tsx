...
import { toggleDashboardSidebar, toggleSidebar } from '../redux/features/toogle/toggle.slice';
...
const SecondaryDashboardSidebar = () => {
    ...
    const isSidebarOpen = useAppSelector((state) => state.toggle.isDashboardSidebarOpen);
  ...
  >
     <div className=" flex flex-col justify-between h-full ">
      ...
      <button  onClick={()=>dispatch(toggleDashboardSidebar())} className=' absolute top-2 right-2 text-black dark:text-white text-4xl'>
      <MdCancel />
      </button>
  </div>
  )
